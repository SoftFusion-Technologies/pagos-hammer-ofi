...
const PrincipalPaseLibre = () => {
  ...
  const handleTransferenciaClick = () => {
    navigate('/concepcion/paselibre/transferencia', { replace: false });
  };

  const handleEfectivoClick = () => {
    navigate('/concepcion/paselibre/efectivo', { replace: false });
  };

  const handleDebitoClick = () => {
    navigate('/concepcion/paselibre/tarjeta-debito', { replace: false });
  };
    ...
    <div className="content">
      ...
      <div className="plan-info">
        <p className="plan-text">
          Estás por abonar tu plan: Pase Libre Concepción
        </p>
      </div>
      <div className="plan-info">
