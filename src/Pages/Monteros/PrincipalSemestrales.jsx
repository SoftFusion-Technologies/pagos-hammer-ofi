...
const PrincipalTrimestrales = () => {
  ...
  const handleTransferenciaClick = () => {
    navigate('/monteros/semestrales/transferencia', { replace: false });
  };

  const handleEfectivoClick = () => {
    navigate('/monteros/semestrales/efectivo', { replace: false });
  };

  const handleDebitoClick = () => {
    navigate('/monteros/semestrales/tarjeta-debito', { replace: false });
  };
    ...
    <div className="content">
      ...
      <div className="plan-info">
        <p className="plan-text">
          Estás por abonar tu plan: semestrales monteros
        </p>
      </div>
      <div className="plan-info">
        <p className="plan-text">Monto a abornar: $114.000</p>
      </div>
